...
@Component({
  selector: 'app-customer-roulette',
  templateUrl: './customer-roulette.page.html',
  styleUrls: ['./customer-roulette.page.scss'],
})
export class CustomerRoulettePage implements OnInit {
  ...
  // retrenchTokens = [4, 4, 6, 6, 8, 8, 10, 10, 12, 12];
