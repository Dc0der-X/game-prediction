...
@Component({
  selector: 'app-customer-lucky-seven',
  templateUrl: './customer-lucky-seven.page.html',
  styleUrls: ['./customer-lucky-seven.page.scss'],
})
export class CustomerLuckySevenPage implements OnInit {
